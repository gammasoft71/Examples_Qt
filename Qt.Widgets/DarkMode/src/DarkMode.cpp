...
private:
  QFrame panel;
  QLabel label {&panel};
  QPushButton pushButton {&panel};
  QListWidget listWidget {&panel};
  QRadioButton radioButton1 {&panel};
  QRadioButton radioButton2 {&panel};
  QCheckBox checkBox1 {&panel};
  QCheckBox checkBox2 {&panel};
};
